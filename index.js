...
async function connectToWA() {
  ...
  console.log("Connecting ❤️MINZ❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️ MINZ❤️ installed successful ✅");
      console.log("❤️MINZ❤️ connected to whatsapp ✅");

      let up = `❤️MINZ❤️ connected successful ✅`;
      let up1 = `Hello MINZ, I made bot successful`;
